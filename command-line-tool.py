...
def main():
    ...
    while True:
        ...
        if what_to_search == "p" and type_of_search == "s":
            ...
            [print(f"Publisher: {publisher[0]}: number of titles: {publisher[1]} ")
             for publisher in publishers_count]
            [print(f"Mean price of titles: {round(publisher[1], 2)} ")
             for publisher in publishers_mean_price]
            [print(f"Median price of titles: {round(publisher[1], 2)} ")
             for publisher in publishers_median_price]
            [print(f"Mean age of titles in years: {round(publisher[1], 2)} ")
             for publisher in publishers_mean_age]
